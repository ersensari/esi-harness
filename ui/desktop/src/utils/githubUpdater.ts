...
export class GitHubUpdater {
  private readonly owner = process.env.GITHUB_OWNER || 'ersensari';
  private readonly repo = process.env.GITHUB_REPO || 'esi-harness';
  private readonly bundleName = process.env.GOOSE_BUNDLE_NAME || 'ESI-Studio';
    ...
    try {
      ...
      const response = await fetch(this.apiUrl, {
        headers: {
          ...
          'User-Agent': `ESI-Studio/${app.getVersion()}`,
        },
